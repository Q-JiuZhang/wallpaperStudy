...
public class MineFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(v -> Toast.makeText(requireContext(), "Mine 按钮1", Toast.LENGTH_SHORT).show());
        b2.setOnClickListener(v -> Toast.makeText(requireContext(), "Mine 按钮2", Toast.LENGTH_SHORT).show());
        return root;
    }
}